...
public class OWLSExtensions {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Service s = kb.readService(URI.create("http://www.mindswap.org/2004/owl-s/1.1/Dictionary.owl"));
        ...
        System.out.println("Display service paramaters using generic functions");
        System.out.println("--------------------------------------------------");
        ...
        System.out.println("Display service paramaters using custom functions");
        System.out.println("-------------------------------------------------");
