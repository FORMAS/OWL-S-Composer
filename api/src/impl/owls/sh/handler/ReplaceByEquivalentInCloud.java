...
public class ReplaceByEquivalentInCloud extends SHDiagnostic {
	
	public ReplaceByEquivalentInCloud(SHHandler successHandler) {
		super(successHandler);
	}
	
	public ValueMap execute(ObjectRequest objectRequest) {
		System.out.println("ReplaceByEquivalentInCloud");
		...
		if(cloudFolder != ""){
			...
			String newURI = getEquivalentURI(objectRequest.getGrounding().getProcess().getURI().toString(), cloudFolder,null);
