...
public class CloudPrePublishAWSWizardPage extends WizardPage {
	private Text accessKey;
	private Text secretKey;

	protected CloudPrePublishAWSWizardPage(String pageName) {
		super(pageName);
	}
	...
	public void createControl(Composite parent) {
		...
		credentialsGroup.setText("Amazon credentials");
