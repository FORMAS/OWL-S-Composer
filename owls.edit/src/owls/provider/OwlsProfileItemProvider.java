...
/**
 * This is the item provider adapter for a {@link owls.OwlsProfile} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OwlsProfileItemProvider
	 ...
	 * @generated
	 */
	public OwlsProfileItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addServiceNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OwlsProfile_serviceName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OwlsProfile_serviceName_feature", "_UI_OwlsProfile_type"),
				 OwlsPackage.Literals.OWLS_PROFILE__SERVICE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OwlsProfile"));
	}
	...
	public String getText(Object object) {
		String label = ((OwlsProfile)object).getID();
		return label == null || label.length() == 0 ?
			getString("_UI_OwlsProfile_type") :
			getString("_UI_OwlsProfile_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OwlsProfile.class)) {
