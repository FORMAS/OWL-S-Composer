package owls.diagram.expressions;
 ...
 * @generated
 */
public abstract class OwlsAbstractExpression {
	...
	private static final boolean DISABLED_NO_IMPL_EXCEPTION_LOG = Boolean
			.valueOf(
					Platform.getDebugOption(OwlsDiagramEditorPlugin
	 ...
	 * @generated
	 */
	protected OwlsAbstractExpression(EClassifier context) {
		this(null, context);
	}
	 ...
	 * @generated
	 */
	protected OwlsAbstractExpression(String body, EClassifier context) {
		this.body = body;
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = OwlsDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	public static final OwlsAbstractExpression createNullExpression(
			EClassifier context) {
		return new OwlsAbstractExpression(context) {
