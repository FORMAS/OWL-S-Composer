...
import owls.diagram.edit.parts.OwlsAssignClientEditPart;
import owls.diagram.part.OwlsVisualIDRegistry;

/**
 * @generated
 */
public class OwlsAssignClientViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = OwlsVisualIDRegistry
					.getType(OwlsAssignClientEditPart.VISUAL_ID);
