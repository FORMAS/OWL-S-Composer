...
import owls.diagram.edit.parts.OwlsAssignClient2EditPart;
import owls.diagram.part.OwlsVisualIDRegistry;

/**
 * @generated
 */
public class OwlsAssignClient2ViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = OwlsVisualIDRegistry
					.getType(OwlsAssignClient2EditPart.VISUAL_ID);
