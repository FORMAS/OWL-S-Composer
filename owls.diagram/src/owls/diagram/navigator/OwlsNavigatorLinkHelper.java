 ...
 * @generated
 */
public class OwlsNavigatorLinkHelper implements ILinkHelper {
	...
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = OwlsDiagramEditorPlugin.getInstance()
	...
	public void activateEditor(IWorkbenchPage aPage,
		...
		OwlsAbstractNavigatorItem abstractNavigatorItem = (OwlsAbstractNavigatorItem) aSelection
				.getFirstElement();
		View navigatorView = null;
		if (abstractNavigatorItem instanceof OwlsNavigatorItem) {
			navigatorView = ((OwlsNavigatorItem) abstractNavigatorItem)
					.getView();
			...
			if (navigatorGroup.getParent() instanceof OwlsNavigatorItem) {
				navigatorView = ((OwlsNavigatorItem) navigatorGroup.getParent())
						.getView();
			}
		}
