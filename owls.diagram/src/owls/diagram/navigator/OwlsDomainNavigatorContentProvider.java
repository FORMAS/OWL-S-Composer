 ...
 * @generated
 */
public class OwlsDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public OwlsDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof OwlsDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier
					.getChildren(((OwlsDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new OwlsDomainNavigatorItem((EObject) objects[i],
