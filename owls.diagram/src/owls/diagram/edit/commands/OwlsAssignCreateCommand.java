 ...
 * @generated
 */
public class OwlsAssignCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public OwlsAssignCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return OwlsBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateOwlsAssign_3001(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		// owls.OwlsAssign newElement = (owls.OwlsAssign) super.doDefaultElementCreation();
		OwlsAssign newElement = OwlsFactory.eINSTANCE.createOwlsAssign();
