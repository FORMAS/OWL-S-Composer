 ...
 * @generated
 */
public class OwlsSplit2CreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public OwlsSplit2CreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		if (newElement != null) {
			OwlsElementTypes.Initializers.OwlsSplit_2003.init(newElement);
		}
		return newElement;
	}
