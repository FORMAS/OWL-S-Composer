 ...
 * @generated
 */
public class OwlsSequenceCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public OwlsSequenceCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		if (newElement != null) {
			OwlsElementTypes.Initializers.OwlsSequence_1001.init(newElement);
		}
		return newElement;
	}
}
