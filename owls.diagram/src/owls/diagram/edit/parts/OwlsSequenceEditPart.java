...
import owls.diagram.edit.policies.OwlsSequenceCanonicalEditPolicy;
import owls.diagram.edit.policies.OwlsSequenceItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OwlsSequenceEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public OwlsSequenceEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OwlsSequenceItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new OwlsSequenceCanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		OwlsSequenceFigure figure = new OwlsSequenceFigure();
	 ...
	 * @generated
	 */
	public OwlsSequenceFigure getPrimaryShape() {
		return (OwlsSequenceFigure) primaryShape;
	}
	...
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(getMapMode()
				.DPtoLP(190), getMapMode().DPtoLP(260));
		return result;
	}
	 ...
	 * @generated
	 */
	public class OwlsSequenceFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrapLabel fFigureSequenceName;

		/**
		 * @generated
		 */
		public OwlsSequenceFigure() {
			...
			this.setPreferredSize(new Dimension(getMapMode().DPtoLP(190),
					getMapMode().DPtoLP(260)));
			this.setSize(getMapMode().DPtoLP(190), getMapMode().DPtoLP(260));
		...
		private void createContents() {
			...
			fFigureSequenceName = new WrapLabel();
			fFigureSequenceName.setText("Sequence");

			fFigureSequenceName.setFont(FFIGURESEQUENCENAME_FONT);

			this.add(fFigureSequenceName);
		...
		private void recursiveResize(EObject host) {
			if (host instanceof OwlsSequenceImpl) {
				...
				if (sequence.getConstructs().size() != 0) {
					...
					int newHeight = (processQuantity * 100);
			...
			if ((host instanceof OwlsSplitImpl)
				...
				if (process.getConstructs().size() != 0) {
					...
					int newWidth = (processQuantity * 75);
		 ...
		 * @generated
		 */
		public WrapLabel getFigureSequenceName() {
			return fFigureSequenceName;
		}
	 ...
	 * @generated
	 */
	static final Font FFIGURESEQUENCENAME_FONT = new Font(Display.getCurrent(),
