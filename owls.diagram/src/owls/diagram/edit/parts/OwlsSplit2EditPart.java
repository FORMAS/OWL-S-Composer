...
import owls.diagram.edit.policies.OwlsSplit2CanonicalEditPolicy;
import owls.diagram.edit.policies.OwlsSplit2ItemSemanticEditPolicy;
import owls.diagram.part.OwlsVisualIDRegistry;

/**
 * @generated
 */
public class OwlsSplit2EditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public OwlsSplit2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OwlsSplit2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new OwlsSplit2CanonicalEditPolicy());
