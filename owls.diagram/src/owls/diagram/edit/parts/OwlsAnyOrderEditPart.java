...
import owls.diagram.edit.policies.OwlsAnyOrderCanonicalEditPolicy;
import owls.diagram.edit.policies.OwlsAnyOrderItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OwlsAnyOrderEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public OwlsAnyOrderEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OwlsAnyOrderItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new OwlsAnyOrderCanonicalEditPolicy());
