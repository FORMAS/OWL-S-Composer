...
import owls.diagram.part.OwlsDiagramEditorUtil;

/**
 * @generated
 */
public class OwlsMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = OwlsDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			OwlsDiagramEditorUtil.selectElementsInDiagram(editor, Arrays
